...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final Button billButton;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView, @NonNull Button billButton,
      @NonNull NestedScrollView bottomSheetLayout, @NonNull ImageView imageView1,
      ...
      @NonNull TextView maxResultsValue, @NonNull TextView proceed,
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.billButton;
      Button billButton = ViewBindings.findChildViewById(rootView, id);
      if (billButton == null) {
        break missingId;
      }
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, billButton, bottomSheetLayout,
          imageView1, inferenceTimeLabel, inferenceTimeVal, maxResultsMinus, maxResultsPlus,
          maxResultsValue, proceed, spinnerDelegate, spinnerModel, threadsMinus, threadsPlus,
